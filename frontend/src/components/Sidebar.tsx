...
export type NavTab = 'overview' | 'payments' | 'recovery' | 'approvals' | 'audit' | 'settings';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { id: 'recovery' as NavTab, label: 'Recovery Workflows', icon: RefreshCw },
    {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-5 border-b border-slate-200 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="font-semibold text-slate-900 text-base tracking-tight leading-none">Vasuli AI</h1>
          ...
          <div className="px-3 py-1.5 bg-emerald-500/10 rounded border border-emerald-500/20 flex items-center justify-center gap-2">
        ...
        {/* Footer Info */}
        <div className="px-4 py-4 border-t border-slate-200 space-y-2 text-xs">
          ...
          <div className="pt-3 border-t border-slate-200 flex items-center space-x-2 text-slate-700">
            ...
            <span className="text-xs font-semibold text-slate-800">Operator Profile</span>
          </div>
        </div>
      </aside>
    </>
