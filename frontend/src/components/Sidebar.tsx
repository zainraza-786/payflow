...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { id: 'transactions' as NavTab, label: 'Transaction Audit', icon: CreditCard },
    { id: 'analytics' as NavTab, label: 'Financial Analytics', icon: PieChart },
    {
    ...
    { id: 'reports' as NavTab, label: 'Export & Reports', icon: FileText },
      ...
      >
        ...
        <div className="p-5 border-b border-slate-200 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="font-headline font-bold text-slate-900 text-base tracking-tight leading-none">PayFlow AI</h1>
                <p className="text-[11px] text-slate-500 font-medium mt-0.5">Fintech Ops Platform</p>
              </div>
            </div>
            <button
              onClick={() => setMobileOpen(false)}
          ...
          <div className="px-3 py-1.5 bg-emerald-500/10 rounded border border-emerald-500/20 flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono-nums text-slate-500 font-medium">v1.0</span>
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded text-xs font-semibold transition-all ${
                  isActive
        ...
        <div className="px-4 py-4 border-t border-slate-200 space-y-2 text-xs bg-slate-50">
          ...
          <div className="flex items-center space-x-2 text-slate-600 text-[11px] font-medium">
            ...
            <span className="font-mono-nums text-[10px] text-amber-800 bg-amber-50 px-1.5 py-0.5 rounded border border-amber-200 font-semibold">
              RAZORPAY TEST MODE
            </span>
          </div>
