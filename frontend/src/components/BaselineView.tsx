  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card-stitch p-6 space-y-4 shadow-sm border-2 border-slate-900">
          <div className="border-b border-slate-200/80 pb-3 flex justify-between items-start">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-slate-900 text-white">OPTIMIZED</span>
          </div>
